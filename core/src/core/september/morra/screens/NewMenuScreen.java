 ...
 */
public class NewMenuScreen extends AbstractGameScreen {
    ...
    public NewMenuScreen(DirectedGame game) {
        super(game);
    ...
    private void addToTable(Table table, Actor actor) {
        table.add(actor).width(Constants.VIEWPORT_HEIGHT/2)
                .height(Constants.VIEWPORT_HEIGHT/5).padBottom(5);
        table.row();
    }
    ...
    private TextButton scoreButton() {
        ...
        button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                NewMenuScreen.this.game.playServices.showScore();
            }
        });

...
public class AndroidLauncher extends AndroidApplication implements PlayServices {
	...
	protected void onCreateOld (Bundle savedInstanceState) {
		...
		initialize(new MorraGame(this), config);
	}
	...
	private AdView createAdView() {
		...
		adView.setId(R.id.adviewId); //n arbitrary id, allows for relative positioning in createGameView()
	...
	private View createGameView(AndroidApplicationConfiguration cfg) {
		...
		gameView = initializeForView(new MorraGame(this), cfg);
		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
	...
	public void submitScore(int highScore)
	{
		if (isSignedIn() == true)
		{
			Games.Leaderboards.submitScore(gameHelper.getApiClient(),
					getString(R.string.leaderboard_best_player), highScore);
		}
	}
	...
	public void showScore()
	{
		if (isSignedIn() == true)
		{
			startActivityForResult(Games.Leaderboards.getLeaderboardIntent(gameHelper.getApiClient(),
					getString(R.string.leaderboard_best_player)), requestCode);
		}
		else
		{
			signIn();
